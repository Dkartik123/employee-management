...
var EmployeesService = /** @class */ (function () {
    function EmployeesService(employeeRepository) {
        this.employeeRepository = employeeRepository;
    }
    EmployeesService.prototype.create = function (createEmployeeDto) {
        var employee = this.employeeRepository.create(createEmployeeDto);
    ...
    EmployeesService.prototype.update = function (id, updateEmployeeDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.employeeRepository.update(id, updateEmployeeDto)];
                    case 1:
                        _a.sent();
